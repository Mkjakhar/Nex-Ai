    ...
    <section className="pb-lg-5 position-relative">
      ...
      <div className="height_750 overflow-scroll mb-5">
        ...
        <div className="processcommon_box purple_box cursor_pointer">
          ...
          <p className=" mb-0 ff_futura fw-normal fs_md mt-2 text_dark_black opacity_07">
            The Nexai ecosystem will feature a robust loyalty program, rewarding
            users with Nex AI tokens for their active engagement, ongoing
            participation, and dedicated usage of Nexai's products and services.
            Token holders will have the opportunity to redeem their accumulated
            rewards for discounts, incentives, or exclusive offers, fostering a
            strong sense of loyalty and encouraging continued involvement.
          </p>
        </div>{" "}
        <div className="processcommon_box yellow_box cursor_pointer">
          ...
          <p className=" mb-0 ff_futura fw-normal fs_md mt-2 text_dark_black opacity_07">
            Nex AI token holders will play a vital role in the governance of the
            Nexai ecosystem. Through voting mechanisms, token holders will have
            a direct say in the decision-making process. They can express their
            opinions, vote on proposed changes or improvements, and actively
            contribute to shaping the future development and direction of the
            Nexai ecosystem.
          </p>
        </div>{" "}
        <div className="processcommon_box pink_box cursor_pointer">
          ...
          <p className=" mb-0 ff_futura fw-normal fs_md mt-2 text_dark_black opacity_07">
            Nex AI tokens will enable seamless peer-to-peer transactions within
            the Nexai community. Users will have the ability to exchange tokens
            with others for various purposes, such as purchasing pre-owned Nexai
            devices, engaging in token trading activities, or conducting value
            exchanges directly within the ecosystem, all with the utmost
        ...
        <div className="processcommon_box green_box cursor_pointer">
          ...
          <p className=" mb-0 ff_futura fw-normal fs_md mt-2 text_dark_black opacity_07">
            ...
            dividends, or other incentives, further incentivizing token holding
            and fostering long-term engagement and loyalty.
          </p>
        </div>
      </div>
    </section>
