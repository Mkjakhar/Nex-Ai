...
const OurTeam = () => {
  return (
    <section className=" bg_blue py-5">
      <Container className="py-lg-5 my-xl-3">
        ...
        <Row className="pt-2 justify-content-center">
          <Col lg={4} sm={6}>
            <div className="team_box overflow-hidden cursor_pointer me-1">
          ...
          <Col lg={4} sm={6}>
            <div className="team_box overflow-hidden cursor_pointer mx-1">
              <img
          ...
          <Col lg={4} sm={6}>
            <div className="team_box mt-4 mt-lg-0 overflow-hidden cursor_pointer ms-1">
              <img
                className="w-100 px-4 pt-4 height_300"
                src={developer}
                alt="developer"
